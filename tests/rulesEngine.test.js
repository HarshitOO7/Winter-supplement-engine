// All the test cases for the Winter Supplement Rules Engine
const { processRules } = require('../helpers/rulesEngine');

describe('Winter Supplement Rules Engine', () => {
    // Eligibility and Calculation Tests
    describe('Eligibility and Calculation Tests', () => {
    ...
    describe('Invalid Inputs and Edge Cases', () => {
        ...
        test('Invalid input: Null input', () => {
            ...
            expect(() => processRules(input)).toThrow("Invalid input: Input cannot be null or empty");
        });
